...
class _EventDetailsPageState extends State<EventDetailsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    void _onSliderChangeEnd(double value) {
      ...
      _isTauxModified = true;
    }

    return WillPopScope(
      onWillPop: () async {
        Navigator.pop(context, _isTauxModified);
        return true;
      },
      child: Scaffold(
        appBar: AppBar(
                    ...
                    if (widget.event.telephone !=
                      ...
                      Row(
                        children: [
                          ...
                          InkWell(
                            onTap: () =>
                                launch('tel:${widget.event.telephone}'),
                            child: Text(
                      ...
                      children: [
                        RatingBar.builder(
                          ...
                          onRatingUpdate: (rating) {
                            _firestoreService
                                .setNote(
                                    widget.event.indexEvent, rating.toInt())
                                .then((_) {
                              setState(() {
